...
#     label: str,
#     owner: str = "None",
#     script_object:MenuCommand=None,
#     command_string: str = "",
#     entry_type: unreal.MultiBlockType = unreal.MultiBlockType.MENU_ENTRY,
# ) -> ToolMenuEntry:
#     menu_entry = ToolMenuEntry(name, unreal.ToolMenuOwner(owner), type=entry_type)
#     menu_entry.set_label(label)
#     if script_object is not None:
#         script_object = script_object.get_script_object()
#         menu_entry.script_object = script_object
